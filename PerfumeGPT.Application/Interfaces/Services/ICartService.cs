...
namespace PerfumeGPT.Application.Interfaces.Services
{
	public interface ICartService
	{
		...
		Task<(List<CartCheckoutItemDto> PricedItems, decimal Subtotal, decimal ShippingFee, decimal FinalTotalPrice, string? VoucherMessage)> CalculateFullCheckoutPricingAsync(
			List<CartCheckoutItemDto> checkoutItems, string? voucherCode, Guid? customerId, string? guestEmailOrPhoneNumber, ContactAddressInformation? recipient, bool isPickupInStore);
