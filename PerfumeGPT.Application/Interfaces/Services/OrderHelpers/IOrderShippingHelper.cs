...
namespace PerfumeGPT.Application.Interfaces.Services.OrderHelpers
{
	...
	{
		Task SetupShippingInfoAsync(Order order, ContactAddressInformation? contactAddressRequest, Guid? customerId, Guid? savedAddressId, decimal shippingFee, DateTime? estimatedDeliveryDate);
