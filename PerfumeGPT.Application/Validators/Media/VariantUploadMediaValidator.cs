...
{
	public class VariantUploadMediaValidator : AbstractValidator<VariantUploadMediaRequest>
	{
		public VariantUploadMediaValidator()
		{
			RuleFor(x => x.Images)
				.NotEmpty().WithMessage("Bắt buộc phải có ít nhất một hình ảnh được tải lên.");
