...
namespace PerfumeGPT.Application.Services
{
    public class ProductService : IProductService
    {
        ...
        #region Product with Variants
        public async Task<BaseResponse<List<Object>>> GetAllProductWithVariantsAsync()
        {
            var result = await _productRepo.GetAllProductWithVariantsAsync();
            return BaseResponse<List<Object>>.Ok(result, "Products with variants retrieved successfully");
        }
        #endregion
    }
}
