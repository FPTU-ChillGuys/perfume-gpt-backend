...
namespace PerfumeGPT.API.Controllers
{
	...
	public class ShippingsController : BaseApiController
	{
		...
		[HttpPost("sync/shipping-status/{trackingNumber}")]
		public async Task<ActionResult<BaseResponse<string>>> SyncShippingStatusByTrackingNumber([FromRoute] string trackingNumber)
		{
			var response = await _shippingService.SyncShippingStatusByTrackingNumberAsync(trackingNumber);
			return HandleResponse(response);
		}
