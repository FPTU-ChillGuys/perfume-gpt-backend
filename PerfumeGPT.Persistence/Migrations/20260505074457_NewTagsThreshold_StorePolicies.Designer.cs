...
namespace PerfumeGPT.Persistence.Migrations
{
    ...
    [Migration("20260505074457_NewTagsThreshold_StorePolicies")]
    partial class NewTagsThreshold_StorePolicies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.Banner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MobileImagePublicId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.Campaign", b =>
                {
                    ...
                    b.HasIndex("Status", "IsDeleted", "StartDate", "EndDate");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.CashFlowLedger", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("StaffId", "Status", "CreatedAt");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.PaymentTransaction", b =>
                {
                    ...
                    b.HasIndex("CreatedAt", "TransactionType", "TransactionStatus");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.PromotionItem", b =>
                {
                    ...
                    b.HasIndex("CampaignId", "IsActive", "IsDeleted");

                    b.HasIndex("TargetProductVariantId", "IsActive", "IsDeleted");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.StorePolicy", b =>
                {
                    ...
                    b.Property<int>("MaxAddressesPerUser")
                        .HasColumnType("int");

                    b.Property<int>("NewTagThresholdInDays")
                        .HasColumnType("int");

                    b.Property<int>("OrderRewardPointsInDays")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReturnOrderAllowanceInDays")
                        .HasColumnType("int");

                    b.Property<int>("ReviewRewardPoints")
                        .HasColumnType("int");

                    b.Property<int>("StockAdjustmentAutoApprovalThreshold")
                        .HasColumnType("int");

                    b.Property<int>("StopSellingBeforeExpiryDays")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NewTagThresholdInDays = 30,
                            OrderRewardPointsInDays = 7,
                            RequiredDepositPercentage = 20m,
                            ReturnOrderAllowanceInDays = 5,
                            ReviewRewardPoints = 50,
                            StockAdjustmentAutoApprovalThreshold = 5,
                            StopSellingBeforeExpiryDays = 7
                        });
                });
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.SystemPage", b =>
                {
                    ...
                    b.ToTable("SystemPages", (string)null);
                });

            modelBuilder.Entity("PerfumeGPT.Domain.Entities.SystemPolicy", b =>
                {
                    ...
                    b.ToTable("SystemPolicies", (string)null);
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("CodBlockedUntil")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("DeliveryRefusalCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.UserDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.UserNotificationRead", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.UserVoucher", b =>
                {
                    ...
                    b.HasIndex("GuestIdentifier", "UserId");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.Voucher", b =>
                {
                    ...
                    b.HasIndex("CampaignId", "ExpiryDate", "IsDeleted");
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.Notification", b =>
                {
                    b.HasOne("PerfumeGPT.Domain.Entities.Stock", null)
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.UserNotificationRead", b =>
                {
                    b.HasOne("PerfumeGPT.Domain.Entities.Notification", "Notification")
                        .WithMany("UserReadStates")
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PerfumeGPT.Domain.Entities.User", "User")
                        .WithMany("NotificationReadStates")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PerfumeGPT.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("NotificationReadStates");
