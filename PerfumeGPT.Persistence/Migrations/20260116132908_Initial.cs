        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScentPreference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    FavoriteNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImportTickets_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalShopeeId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_Concentrations_ConcentrationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Batches_ImportDetails_ImportDetailId",
                        column: x => x.ImportDetailId,
                        principalTable: "ImportDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Batches_ProductVariants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Batches_ImportDetailId",
                table: "Batches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportDetails_ProductVariantId",
                table: "ImportDetails",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportTickets_CreatedById",
                table: "ImportTickets",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ConcentrationId",
